...
if [ -f "/workspace/projects/sjd_pediatric_tumors/second-tumors-children/duplex_analysis/signature_analysis/qmap_files/06_msigact_script_per_sample_synthetic_sensitibity_injections_20240308/3.env" ]; then
	source "/workspace/projects/sjd_pediatric_tumors/second-tumors-children/duplex_analysis/signature_analysis/qmap_files/06_msigact_script_per_sample_synthetic_sensitibity_injections_20240308/3.env"
fi
